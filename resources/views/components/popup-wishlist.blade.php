      ...
      <div class="box-wishlist-wrapper"><a class="btn-close-popup" href="#">
        ...
        <div class="box-products-cart">
          <div class="box-empty-cart d-none">
            <div class="icon-empty-cart"><img src="/assets/imgs/template/icons/empty-cart.svg" alt="ROSA"></div>
          ...
          <div class="list-items-cart">
            <div class="item-cart">
              <div class="item-cart-image"><img src="/assets/imgs/page/cart/sp.png" alt="ROSA"></div>
              <div class="item-cart-info">
                <div class="item-cart-info-1"><a class="text-16-medium" href="#">Ball Crew Shirt</a>
                  ...
                  <p class="body-p2 d-block d-sm-none mb-8">SR24.00</p>
                  <div class="box-form-cart">
                    <div class="btn btn-black">Add to cart</div>
                  </div>
                </div>
                <div class="item-cart-info-2">
                  <p class="body-p2 d-none d-sm-block">SR24.00</p><a class="btn-remove-cart" href="#"></a>
                </div>
              </div>
            </div>
            <div class="item-cart">
              <div class="item-cart-image"><img src="/assets/imgs/page/cart/sp2.png" alt="ROSA"></div>
              <div class="item-cart-info">
                <div class="item-cart-info-1"><a class="text-16-medium" href="#">Ball Crew Shirt</a>
                  <div class="box-info-size-color-product">
                    <p class="box-color"><span class="body-p2 neutral-medium-dark">Color:</span><span class="body-p2 neutral-dark">Navy</span></p>
            ...
            <div class="item-cart">
              <div class="item-cart-image"><img src="/assets/imgs/page/cart/sp3.png" alt="ROSA"></div>
              <div class="item-cart-info">
                <div class="item-cart-info-1"><a class="text-16-medium" href="#">Ball Crew Shirt</a>
                  <div class="box-info-size-color-product">
                    <p class="box-color"><span class="body-p2 neutral-medium-dark">Color:</span><span class="body-p2 neutral-dark">Navy</span></p>
          ...
          <div class="box-list-product-search">
            <div class="item-product-search">
              <div class="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="/assets/imgs/page/popup/product-1.png" alt="ROSA"><img class="imageHover" src="/assets/imgs/page/popup/product-5.png" alt="ROSA"></a>
                ...
                <div class="cardInfo">
                  ...
                  <p class="body-p2 cardDesc">SR24.00</p>
                </div>
              </div>
            </div>
            <div class="item-product-search">
              <div class="cardProductStyle3 cardProductType03 cardProductType02 wow fadeInUp">
                <div class="cardImage"><a href="#"><img class="imageMain" src="/assets/imgs/page/popup/product-2.png" alt="ROSA"><img class="imageHover" src="/assets/imgs/page/popup/product-6.png" alt="ROSA"></a>
                  <div class="button-select"><a href="#">Select Options</a></div>
                  <div class="box-quick-button"><a class="btn" href="#">
                      <svg class="d-inline-flex align-items-center justify-content-center" width="28" height="28" viewbox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_116_452)">
                ...
                <div class="cardInfo">
                  ...
                  <p class="body-p2 cardDesc">SR36.00</p>
                </div>
              </div>
            </div>
          </div>
